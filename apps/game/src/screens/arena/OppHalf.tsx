 ...
 *  Which reveal mode shows is decided in the view-model (`oppMode*` flags). */
export function OppHalf({ vm }: { vm: ViewModel }) {
  return (
    <div data-tut="opp" style={vm.oppHalfStyle}>
      <div style={css('width: 250px; height: 330px; position: relative;')}>
        {vm.oppModeSil && (
          <div
            style={css(
